...
public class LoadData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        rateRepo.save(new CDRates("20231201m12S10kAR","M1",4.5,4.7, 4.6, "AR", 1000,100000,10, 5, "S","Y",parseDate("2024-01-15"), parseDate("2024-03-31"),"TestUser", "AdminUser"));
        rateRepo.save(new CDRates("20231201m12S10kFL","M1",4.5,4.7, 4.6, "FL", 1000,100000,10, 5, "S","Y",parseDate("2024-01-15"), parseDate("2024-03-31"),"TestUser", "AdminUser"));
        rateRepo.save(new CDRates("20231201m12S10kIL","M1",4.5,4.7, 4.6, "IL", 1000,100000,10, 5, "S","Y",parseDate("2024-01-15"), parseDate("2024-03-31"),"TestUser", "AdminUser"));
        rateRepo.save(new CDRates("20231201m12S10kLA","M1",4.5,4.7, 4.6, "LA", 1000,100000,10, 5, "S","Y",parseDate("2024-01-15"), parseDate("2024-03-31"),"TestUser", "AdminUser"));
        rateRepo.save(new CDRates("20231201m12S10kME","M1",4.5,4.7, 4.6, "ME", 1000,100000,10, 5, "S","Y",parseDate("2024-01-15"), parseDate("2024-03-31"),"TestUser", "AdminUser"));
        rateRepo.save(new CDRates("20231201m12S10kNH","M1",4.5,4.7, 4.6, "NH", 1000,100000,10, 5, "S","Y",parseDate("2024-01-15"), parseDate("2024-03-31"),"TestUser", "AdminUser"));
        rateRepo.save(new CDRates("20231201m12S10kNJ","M1",4.5,4.7, 4.6, "NJ", 1000,100000,10, 5, "S","Y",parseDate("2024-01-15"), parseDate("2024-03-31"),"TestUser", "AdminUser"));
